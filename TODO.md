...
## To Test (on device)
- [ ] Feedback & Ideas section in Settings — verify "Report a Bug" and "Request a Feature" open Mail with pre-filled templates
- [ ] "Rate TacoScout" button triggers the App Store review prompt
